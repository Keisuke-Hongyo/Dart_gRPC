...
class HelloClient extends $grpc.Client {
  ...
  $grpc.ResponseStream<$0.responseHello> sayHelllo(
      $async.Stream<$0.callHello> request,
      {$grpc.CallOptions? options}) {
    return $createStreamingCall(_$sayHelllo, request, options: options);
  }
}
...
abstract class HelloServiceBase extends $grpc.Service {
  ...
  $async.Stream<$0.responseHello> sayHelllo(
      $grpc.ServiceCall call, $async.Stream<$0.callHello> request);
}
