...
class HelloClient extends $grpc.Client {
  ...
  $grpc.ResponseStream<$0.responseHello> sayHelllo($0.callHello request,
      {$grpc.CallOptions? options}) {
    return $createStreamingCall(
        _$sayHelllo, $async.Stream.fromIterable([request]),
        options: options);
  }
}
...
abstract class HelloServiceBase extends $grpc.Service {
  ...
  $async.Stream<$0.responseHello> sayHelllo_Pre(
      $grpc.ServiceCall call, $async.Future<$0.callHello> request) async* {
    yield* sayHelllo(call, await request);
  }
